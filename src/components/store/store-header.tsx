...
import { Facebook, MapPin, MessageCircle, Music2, Search, ShieldCheck, Truck } from "lucide-react";
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-slate-200 bg-white shadow-sm shadow-slate-200/60">
      <div className="bg-[#003f48] text-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-1.5 text-xs font-semibold">
          ...
          <div className="inline-flex items-center gap-3">
            <Link href={facebookUrl} target="_blank" className="inline-flex items-center gap-1 text-white hover:text-[#c9f7f7]">
              <Facebook className="h-3.5 w-3.5" />
              Facebook
            </Link>
            <Link href={tiktokUrl} target="_blank" className="inline-flex items-center gap-1 text-white hover:text-[#c9f7f7]">
      ...
      <div className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3">
        <Link href="/tienda" className="flex min-w-fit items-center gap-3">
    ...
    />
        ...
        <form action="/tienda" className="relative flex-1">
